...
const Sobre: React.FC = () => {
    return (
        <div className='relative z-10 w-full'>
            <div className='relative w-full z-10 flex mt-[-150px] md:mt-[-250px] justify-center text-center md:text-left md:justify-between'>
                <div className='relative z-10 flex flex-col md:flex-row bg-red-500/0 w-[70%] rounded-br-[300px] md:p-12 gap-8'>
                    <div className='z-10 w-full md:w-1/2 flex flex-col items-center gap-4 '>
                        <h3 className='text-lg font-bold text-sky-100'>MAZDA? DE GRAÇA?</h3>
                    ...
                    <div className='z-10 w-full md:w-1/2 flex flex-col gap-4 mb-40 '>
                ...
                <div className="custom-shape-divider-bottom-1723485188 z-0 hidden md-block">
