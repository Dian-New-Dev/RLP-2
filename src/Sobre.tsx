...
const Sobre: React.FC = () => {
    return (
        <div className='relative z-10'>
            <div className='relative z-10 flex mt-[-250px] justify-between'>
                <div className='relative z-10 flex bg-red-500/0 w-[70%] rounded-br-[300px] p-12 gap-8'>
                    <div className='z-10 w-1/2 flex flex-col gap-4 '>
                    ...
                    <div className='z-10 w-1/2 flex flex-col gap-4 mb-40 '>
                ...
                <div className="custom-shape-divider-bottom-1723485188 z-0 ">
