    ...
    return (
        <div className='relative'>
           <div className={`z-50 w-full fixed top-0 left-0 p-8`}>
            ...
            <img className='z-50 px-8 py-5 absolute top-1 right-0 w-[115px] scale-[1]' src={"./assets/images/logo.png"} alt="Logo da empresa" />
                ...
                >
                    ...
                    <a onClick={abrirMenu} className='z-40 text-3xl font-normal text-sky-200' href="#C">Como Participar</a>
                    <a onClick={abrirMenu} className='z-40 text-3xl font-normal text-sky-200' href="#D">Formulário</a>
                </div>

            </div> 

            <div className={`z-40 w-full fixed top-0 left-0 p-8 transicao-opacidade ${rolouScroll ? 'nao-opaco' : 'opaco'}`}></div>
        </div>
