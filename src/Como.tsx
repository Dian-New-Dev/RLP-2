...
const Como: React.FC = () => {
    return (
        <div id='C' className='flex z-20 bg-blue-300  relative p-4 mt-20 md:mt-[-1px] pt-20 md:pt-20 xl:pt-64 md:p-12 text-center md:text-left'>
            <div className='relative z-10 flex flex-col gap-8 text-gray-700 '>
                ...
                <div className='grid place-items-center'>
                    <button className='bg-orange-300 hover:bg-orange-400 rounded-full w-52 py-4 font-bold text-sky-100'>Página da Live</button>
                </div>
